...
// The vocabulary is maintained in ./slop-rules.js and shared with the URL-safe
// retitler. Keep the local names so the existing classification/report code stays
// unchanged.
const OFF_TOPIC = OFF_TOPIC_RULES;
const AI_SLOP = AI_SLOP_RULES;
