    ...
    <Link href="/" aria-label="Xylos AI Home" className={`flex items-center gap-3 group/logo ${className}`}>
      ...
      {showText && (
        <div className="flex flex-col">
          <span className="font-sora font-black text-2xl tracking-tighter uppercase leading-none text-white">
            Xylos<span className="bg-gradient-to-r from-[#00f0ff] to-[#0099ff] bg-clip-text text-transparent italic">AI</span>
          </span>
        </div>
      )}
    </Link>
