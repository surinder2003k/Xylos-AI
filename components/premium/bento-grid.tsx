...
export function BentoCard({ children, className = "", delay = 0 }: BentoCardProps) {
  return (
    <TiltCard degree={3} className={`relative overflow-hidden bg-card/25 border border-border/40 backdrop-blur-xl group/card shadow-[0_8px_30px_rgba(0,0,0,0.01)] hover:shadow-[0_15px_45px_rgba(0,0,0,0.04)] hover:border-primary/30 transition-all duration-500 rounded-[2rem] ${className}`}>
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.015)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.015)_1px,transparent_1px)] bg-[size:20px_20px] opacity-60 pointer-events-none" />
