  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <Link 
          href="/dashboard/chat"
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-[#17181b] font-bold hover:shadow-lg transition-all group"
        >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {tools.map((tool, idx) => (
          ...
          >
            <Link 
              href={`/tools/${tool.id}`}
              className="group flex flex-col h-full p-8 rounded-2xl editorial-card hover:border-primary/30 hover:shadow-lg transition-all cursor-pointer relative overflow-hidden"
            >
