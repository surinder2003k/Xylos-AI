...
function SkeletonCard() {
  return (
    <div className="p-6 rounded-2xl space-y-4" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(59,73,75,0.2)' }}>
      ...
      <div className="h-8 w-24 rounded-lg animate-pulse mt-4" style={{ background: 'rgba(0,240,255,0.08)', animationDelay: '360ms' }} />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-10 p-6 md:p-10 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col gap-3">
        <div className="h-3 w-40 rounded animate-pulse" style={{ background: 'rgba(0,240,255,0.1)' }} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="p-6 rounded-2xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(59,73,75,0.2)' }}>
            <div className="h-3 w-20 rounded animate-pulse mb-3" style={{ background: 'rgba(255,255,255,0.06)', animationDelay: `${i * 120}ms` }} />
            <div className="h-7 w-14 rounded animate-pulse" style={{ background: 'rgba(0,240,255,0.1)', animationDelay: `${i * 120 + 80}ms` }} />
          </div>
        ))}
      </div>
