...
export default function OfflinePage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: '#0d0e10', color: '#eeeae2' }}>
      <main className="text-center space-y-8 max-w-md">
        ...
        <p className="text-lg" style={{ color: '#b8b4ac' }}>
        ...
        <div className="flex justify-center gap-6 text-[10px] uppercase tracking-widest" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
          <a href="/" className="hover:text-[#36b7b0] transition-colors" style={{ color: '#8d8b85' }}>Home</a>
