...
export default async function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden text-white selection:bg-cyan-500/30" style={{ background: '#07080d' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link
                    href="/about"
                    className="group flex items-center justify-center gap-3 px-8 py-4 text-gray-400 font-bold text-sm uppercase tracking-wider rounded-xl transition-all duration-300" style={{ border: '1px solid rgba(6,182,212,0.2)' }}
                  >
                    Explore Platform
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {blogs?.map((blog) => (
              <Link key={blog.id} href={`/blog/${blog.slug || blog.id}`} className="group">
                <div className="relative aspect-[16/10] overflow-hidden mb-4 rounded-2xl" style={{ background: 'rgba(6,182,212,0.03)', border: '1px solid rgba(6,182,212,0.06)' }}>
                  <img
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="group p-6 rounded-2xl transition-all duration-300" style={{ border: '1px solid rgba(6,182,212,0.06)', background: 'rgba(6,182,212,0.015)' }}>
          ...
          <div className="relative rounded-3xl overflow-hidden p-12 md:p-16 text-center" style={{ background: 'linear-gradient(135deg, rgba(6,182,212,0.08), rgba(139,92,246,0.06))', border: '1px solid rgba(6,182,212,0.15)' }}>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/about"
                  className="group inline-flex items-center gap-3 px-8 py-4 text-gray-400 font-bold uppercase tracking-wider rounded-xl transition-all duration-300" style={{ border: '1px solid rgba(6,182,212,0.2)' }}
                >
                  Learn More
                </Link>
              </div>
      ...
      {/* ===== FOOTER ===== */}
      <footer className="relative z-10 py-16 px-6 md:px-12 lg:px-20" style={{ borderTop: '1px solid rgba(6,182,212,0.06)', background: 'rgba(0,0,0,0.3)' }}>
        <div className="max-w-7xl mx-auto">
